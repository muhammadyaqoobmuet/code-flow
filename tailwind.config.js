    ...
    theme: {
        extend: {
            ...
            animation: {
                ...
                'waveform-bar-1': 'waveform-bar 1s ease-in-out infinite 0s',
                'waveform-bar-2': 'waveform-bar 1s ease-in-out infinite 0.2s',
                'waveform-bar-3': 'waveform-bar 1s ease-in-out infinite 0.4s',
            },
            boxShadow: {
